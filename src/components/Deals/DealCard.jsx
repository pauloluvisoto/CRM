      ...
      {!isDragging && (
        <div style={{ marginLeft: '8px' }}> {/* Offset for accent */}
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <h4 style={{ margin: 0, fontSize: '13px', fontWeight: '600', color: '#fff', lineHeight: '1.2' }}>
              {deal.title}
            </h4>
            <span style={{ fontSize: '11px', color: '#a1a1aa', marginTop: '1px' }}>
              {deal.company}
            </span>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '6px' }}>
            ...
            {/* Value */}
            <div>
              <span style={{ fontSize: '9px', textTransform: 'uppercase', color: '#71717a', fontWeight: 'bold', display: 'block' }}>
                VALOR
              </span>
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '11px', color: '#d4d4d8' }}>
                {deal.contact_name ? (
                  <>
